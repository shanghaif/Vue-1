  ...
  import globalMixin from "../mixins/global";
    export default {
      ...
      methods: {
        ...
        getSavePersonSmoke() {
          let that = this;
          that.$axios.get(that.$api.GetPersonSmokeApi)
            .then(function(res){
              if (res.data.IsSuccess === true) {
                ...
                if(that.isActive === 0) {
                  ...
                  that.isActiveChild = getData.QuitSecondhandSmoke;
                }
                else {
                  that.isActiveChild = getData.SecondhandSmoke;
                }
              }
            })
        ...
        setSavePersonSmoke() {
          ...
          that.$axios.post(that.$api.SavePersonSmokeApi,upData)
            .then(function(res){
              if (res.data.IsSuccess === true) {
                console.log(res.data);
              }
